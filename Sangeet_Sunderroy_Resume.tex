...
\mynames{Sunderroy/Sangeet\bibnamedelima S}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Sangeet Sourav Sunderroy}
  
  \makefield{\faGithub}{\href{https://github.com/sangeetsourav}{\texttt{sangeetsourav}}}
  \makefield{\faEnvelope[regular]}{\href{mailto:sangeetsourav@gmail.com}{\texttt{sangeetsourav@gmail.com}}}
  % \makefield{\faTwitter}{\href{https://twitter.com/overleaf_example}{\texttt{@overleaf\_example}}}
  \makefield{\faLinkedin}{\href{https://www.linkedin.com/in/sangeet-sunderroy/}{\texttt{sangeet-sunderroy}}}
  \makefield{\faPhone}{\texttt{+91-9928838415}}
  % \makefield{\faMapMarker}{Bengaluru, IN}
  % %% Next line
